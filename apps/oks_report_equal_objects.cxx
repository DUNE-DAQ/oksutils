...
struct SortObjById
{
  bool operator()(const OksObject* o1, const OksObject* o2) const { return o1->GetId() < o2->GetId(); }
};
...
static void
process_class(const OksClass* c, bool verbose)
{
...
main(int argc, char** argv)
{
  ...
  try {
    po::options_description desc("This program is loading OKS data files and searching for equal object.\nUsage: "
                                 "oks_report_equal_objects [options] [-f] file+  ");
    ...
    desc.add_options()(
      ...
      "verbose,v", "Run in verbose mode")("help,h", "Print help message");
    ...
    if (files.empty()) {
      throw std::runtime_error("Missing application name");
    }
