...
main()
{
  try {
    ...
    OksAttribute* n =
      new OksAttribute("Name", OksAttribute::string_type, false, "", "Unknown", "is used to set person's name", true);

    // define attribute 'Birthday'
    OksAttribute* a = new OksAttribute(
      "Birthday", OksAttribute::date_type, false, "", "1997-04-19", "is used to set person's birthday", true);
